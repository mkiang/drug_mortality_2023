...
research letter, [“Recent drug overdose mortality decline compared to pre-COVID trend”](TODO),
...
> Kiang MV, Humphreys K. Recent drug overdose mortality decline compared to pre-COVID trend. *JAMA Network Open*.
...
use the [NCI Joinpoint Regression Program](https://surveillance.cancer.gov/joinpoint/). We save the joinpoint session file and output file in `./joinpoint`. (This should be done after running the `01` script but before the `02` script.)
